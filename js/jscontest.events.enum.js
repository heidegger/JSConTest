  ...
  function create(divId, enType) {
    ...
    function assertParam(cl,pl,str) {
      ...
      if (aP < 10) {
        log_console.innerHTML = 
          log_console.innerHTML + 
          str + ": " +
          "Parameters passed to function not valid: " + cl + ", " + P.utils.valueToString(pl) + "<br/>\n";
      };
    };
    function strEffect(obj, prop, effl_str, eff_str, kind) {
      return "Effect Error, " + kind + " access not allowed! "
        ...
        + "Permissions you have to respect: " 
        + effl_str 
        + "<br />\n"
        + "The following was not respected: " 
        + eff_str 
        + "<br />\n";
    };
    ...
    function assertReturn(cl,v) {
      ...
      if (aR < 10) { 
        log_console.innerHTML = log_console.innerHTML + 
          "Return value of " + cl + " not valid: " + P.utils.valueToString(v); 
      };
    };
    var o = 
      { fail: function (v,c,anz) {
        ...
        error: function (e,c,params) { 
          app("While testing contract " + c.getcdes() + 
              ", an error happens: " + e);
