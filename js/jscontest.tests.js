...
(function(P) {
	...
	function run(afterRun) {
		function logCExp() {
			...
			fire.call(P, 'stat', testContracts, testCount, failCount, verifyContracts,
	...
	T.Top = new SContract(function() {
		return true;
	}, P.gen.genTop, "top");
	T.TopOUndef = new SContract(function(v) {
		return (v !== undefined);
	...
	T.Boolean = new SContract(P.check.isBoolean, P.gen.genBoolean, "boolean",
	                          ctBasic);
	T.True = new SingletonContract(true, 'true');
	T.False = new SingletonContract(false, 'false');
	T.String = new SContract(P.check.isString, P.gen.genString, 'string', ctBasic);
	T.Number = new SContract(P.check.isNumber, P.gen.genNumber, "number", ctBasic);
	T.Integer = new SContract(P.check.isInt, P.gen.genInt, "integer", ctBasic);
	...
	T.Id = new SContract(function(x, y) {
		return x === y;
	}, function(x) {
		return x;
	}, "Id", ctBasic);
	...
	T.Object = new SContract(P.check.isObject, P.gen.genObject, "object",
	                         ctObject);
	/* Object with properties, that are simple. Property names 
	 * only contains characters and digits. 
	 */
	T.SObject = new SContract(P.check.isObject, P.gen.genSObject, "sobject",
	                          ctObject);
